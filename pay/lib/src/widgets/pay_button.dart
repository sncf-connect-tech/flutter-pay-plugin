...
abstract class PayButton extends StatefulWidget {
  ...
  PayButton(
    ...
    if (paymentConfigurationAsset != null &&
        paymentConfigurationString != null) {
      throw Exception(
          "Multiple configurations provided. Either a 'paymentConfigurationAsset' or a 'paymentConfigurationString' must be passed in as an argument.");
    }
